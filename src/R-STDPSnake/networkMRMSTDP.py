...
class SpikingNeuralNetwork():
    def __init__(self):
        ...
        self.stdp_synapse_params = {"vt": self.VolumeTransmitter[0], 'A_plus' : 1., 'A_minus' : 1., 'Wmin' : 0., 'Wmax' : 30., 'tau_c' : 1000., 'tau_n' : 200.}
        ...
        nest.Connect(self.neuron_pre, self.neuron_post, "all_to_all", p.inh_syn_params)
    ...
    def simulate(self, dvs_data, reward_conditional, reward_collision):
        for synapse in self.conn_l:
            ...
            nest.SetStatus([synapse], {"n": (reward_conditional*p.reward_factor - reward_collision) * weight})
